      ...
      *FILE USED FOR THE PROGRAM
       ...
       01 F-DATA.
         ...
         02 F-BALANCE PIC 9(12) VALUE ZEROES.
      ...
      *TRANSACTION VARIABLES FOR COMPUTATION
       01 WS-DEPOSIT PIC 9(12).
       01 WS-WITHDRAW PIC 9(12).
      *QUIT VARIABLE
       01 WS-QUIT PIC X.
      ...
      *DEPOSIT SECTION
       P-DEPOSIT.
           ...
           ACCEPT WS-AMOUNT AT 0874.
           MOVE WS-AMOUNT TO WS-DEPOSIT.
           COMPUTE F-BALANCE = F-BALANCE + WS-DEPOSIT.
           REWRITE F-DATA
           END-REWRITE.
      ...
      *WITHDRAW SECTION
       P-WITHDRAW.
           ...
           ELSE IF WS-WITHDRAW IS GREATER THAN F-BALANCE THEN
               DISPLAY "INSUFFICIENT BALANCE" AT 0949 FOREGROUND-COLOR 4
           ELSE
               SUBTRACT WS-WITHDRAW FROM F-BALANCE
               GIVING F-BALANCE
               REWRITE F-DATA
               END-REWRITE
