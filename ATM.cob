      ...
      *FILE USED FOR THE PROGRAM
       ...
       FD USERDATA.
       01 F-DATA.
         02 F-PASSWORD PIC 9(6) VALUE ZEROES.
      ...
      * VARIABLES FOR BORDER LINE
       ...
       SIGN-IN.
           ...
           END-IF.
<<<<<<< HEAD
           MOVE 1 TO WS-IS-EXISTS
           DISPLAY "GENERATED PIN:" AT 1050.
           PERFORM UNTIL WS-IS-EXISTS = 0
             COMPUTE F-PASSWORD = FUNCTION RANDOM * (99999 + 1) +
             99999
...
=======
           ...
           ELSE
               ...
               AT 1440
           END-IF.
>>>>>>> parent of 0f895fd (ADDED LITTLE DESIGN)
           PERFORM P-PAUSE.
           EXIT.
       LOG-IN.
           MOVE 0 TO WS-IS-EXISTS.
...
<<<<<<< HEAD
           ...
           DISPLAY "ENTER YOUR PIN:" AT 0850.
...
<<<<<<< HEAD
             DISPLAY "YOU ENTERED WRONG PIN" AT 1048
             FOREGROUND-COLOR 4
             PERFORM P-PAUSE
           ELSE
